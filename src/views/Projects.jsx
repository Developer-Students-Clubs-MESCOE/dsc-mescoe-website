import {Toolbar, Button, CardActionArea, Card, CardMedia, CardContent, CardActions, Fade, Backdrop, Modal} from '@material-ui/core';
		...
		return (
			...
			<Modal
						...
						<Card style={{ borderRadius: 10 }}>
								...
								<Form onSubmit={this.handleSubmit}>
									...
									<Form.Group controlId="projectTitle">
										...
										<Form.Control type="text" name="title" onChange={this.handleChange} value={this.state.title} placeholder="Enter Project Title" required/>
									...
									<Form.Group controlId="projectDescription">
										...
										<Form.Control as="textarea" rows="3" name="description" onChange={this.handleChange} value={this.state.description} placeholder="Enter Project Description" required/>
										<Form.Text className="text-muted">
									...
									<Form.Group controlId="projectThumbnail">
										...
										<Form.Control type="text" name="image" onChange={this.handleChange} value={this.state.image} placeholder="Enter Thumbnail Image's Link" />
										<Form.Text className="text-muted">
									...
									<Form.Group controlId="projectYouTube">
										...
										<Form.Control type="text" name="youtube" onChange={this.handleChange} value={this.state.youtube} placeholder="Enter Project's YouTube Demo Link" />
										<Form.Text className="text-muted">
										Provide the link copied from the address bar in the browser to avoid any errors.
										</Form.Text>
									</Form.Group>
									...
									<Form.Group controlId="projectGitHub">
										...
										<Form.Control type="text" name="github" onChange={this.handleChange} value={this.state.github} placeholder="Enter Project's GitHub Repository Link" />
										<Form.Text className="text-muted">
										Provide the link copied from the address bar in the browser to avoid any errors.
										</Form.Text>
									</Form.Group>
				...
				<Container>
					...
					<Row className="ml-3">
						{this.state.projects.map((project, index) => <Col xs="12" key={index} className="p-0 pr-4 mt-5" md="6" lg="4">
							<Card style={{
