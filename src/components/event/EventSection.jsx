...
import {Button, CardActionArea, Card, CardMedia, CardContent, CardActions, Hidden, Collapse, Fade, Backdrop, Modal} from '@material-ui/core';
          ...
          <React.Fragment>
                ...
                <Card style={{
                        ...
                        <CardActionArea>
                            ...
                            <Col md={-4} xs={-4}  style={{ marginLeft: 5 }}>
                                ...
                                <Col>
                                    {Date(this.state.card.dateNtime).toString()}
                                </Col>
                            </Row>
                            </CardContent>
                        </CardActionArea>
                        <CardActions style={{ alignContent: 'flex-end' }}>
                            <Button variant="outlined" style={{color: '#4285F4', borderColor: '#4285F4', alignSelf: 'right'}}>
                                Register
                            </Button>
                        </CardActions>
                    </Card>
            ...
            <Col xs="12" md={data.image ? "6" : null} lg={data.image ? "6" : null} className='p-0 my-auto'
              ...
              <Button
                    ...
                    ref={( node ) => { this.accordian = node }}
                    onClick={() => { this.setState({ openUp: !this.state.openUp }) }}
