...
const ROUTES = [
  ...
  {
    icon: null,
    name: 'ASJ-SpeakerSession',
    path: '/ASJ-SpeakerSession',
    component: (
      <Redirect
        path='/ASJ-SpeakerSession'
        url='https://teams.microsoft.com/l/meetup-join/19%3ameeting_ZTBmNzcxZTUtN2E4OC00NDI2LWI2MTktODIzM2IwODFlMDZl%40thread.v2/0?context=%7b%22Tid%22%3a%22a3d598b6-6092-4351-b1a3-b213e8adc03b%22%2c%22Oid%22%3a%22105d357b-9536-4050-bdb5-0d5c3c247423%22%7d'
      />
    ),
    type: RouteType.PAGE,
  },
